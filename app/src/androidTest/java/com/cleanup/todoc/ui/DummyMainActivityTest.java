...
public class DummyMainActivityTest {

    @Rule
    public ActivityTestRule<MainActivity> mActivityTestRule = new ActivityTestRule<>(MainActivity.class);

    @Test
    public void dummyMainActivityTest() {
        ...
        ViewInteraction appCompatEditText2 = onView(
                allOf(withId(R.id.txt_task_name), withText("aaa"),
                        childAtPosition(
                                childAtPosition(
                                        withId(R.id.custom),
                                        0),
        ...
        ViewInteraction appCompatEditText3 = onView(
                allOf(withId(R.id.txt_task_name),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        appCompatEditText3.perform(replaceText("zzz"), closeSoftKeyboard());
